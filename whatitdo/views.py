...
def userhome(request,list_owner):
	...
	return render_to_response('userhome.html', {'booksize': book_size, 'tvsize': tv_size, 'moviesize': movie_size, 'gamesize': game_size, 'musicsize': music_size, 'lastlogin': last_login, 'datejoined': date_joined, 'listowner': list_owner, 'userpic':userpic, 'link1':link1, 'link2':link2, 'link3':link3}, 
...
def books(request,list_owner):
	...
	return render_to_response('books.html', {'booklist': book_list, 'listowner': list_owner}, 
	RequestContext(request))
...
def tv(request,list_owner):
	...
	return render_to_response('tv.html', {'tvlist': tv_list, 'listowner': list_owner}, 
	RequestContext(request))
...
def movies(request,list_owner):
	...
	return render_to_response('movies.html', {'movielist': movie_list, 'listowner': list_owner}, 
	RequestContext(request))
...
def games(request,list_owner):
	...
	return render_to_response('games.html', {'gamelist': game_list, 'listowner': list_owner}, 
	RequestContext(request))
...
def music(request,list_owner):
	...
	return render_to_response('music.html', {'musiclist': music_list, 'listowner': list_owner}, 
	RequestContext(request))
...
def editbook(request,list_owner,pk):
	...
	return render_to_response('editbook.html', {'listowner': list_owner, 'item_to_edit': item_to_edit, 'form':form}, RequestContext(request))
...
def edittv(request,list_owner,pk):
	...
	if request.method == 'POST':
		...
		form = EditItem(instance=item_to_edit)
	return render_to_response('edittv.html', {'listowner': list_owner, 'item_to_edit': item_to_edit, 'form':form}, RequestContext(request))
...
def editmovie(request,list_owner,pk):
	...
	if request.method == 'POST':
		...
		form = EditItem(instance=item_to_edit)
	return render_to_response('editmovie.html', {'listowner': list_owner, 'item_to_edit': item_to_edit, 'form':form}, RequestContext(request))
...
def editgame(request,list_owner,pk):
	...
	if request.method == 'POST':
		...
		form = EditItem(instance=item_to_edit)
	return render_to_response('editgame.html', {'listowner': list_owner, 'item_to_edit': item_to_edit, 'form':form}, RequestContext(request))
...
def editmusic(request,list_owner,pk):
	...
	if request.method == 'POST':
		...
		form = EditItem(instance=item_to_edit)
	return render_to_response('editmusic.html', {'listowner': list_owner, 'item_to_edit': item_to_edit, 'form':form}, RequestContext(request))
...
def newbook(request,list_owner):
	...
	if request.method == 'POST':
		...
		form = EditItem()
	return render_to_response('editbook.html', {'listowner': list_owner, 'form':form}, RequestContext(request))
...
def newtv(request,list_owner):
	...
	if request.method == 'POST':
		...
		form = EditItem()
	return render_to_response('edittv.html', {'listowner': list_owner, 'form':form}, RequestContext(request))
...
def newmovie(request,list_owner):
	...
	if request.method == 'POST':
		...
		form = EditItem()
	return render_to_response('editmovie.html', {'listowner': list_owner, 'form':form}, RequestContext(request))
...
def newgame(request,list_owner):
	...
	if request.method == 'POST':
		...
		form = EditItem()
	return render_to_response('editgame.html', {'listowner': list_owner, 'form':form}, RequestContext(request))
...
def newmusic(request,list_owner):
	...
	if request.method == 'POST':
		...
		form = EditItem()
	return render_to_response('editmusic.html', {'listowner': list_owner, 'form':form}, RequestContext(request))
